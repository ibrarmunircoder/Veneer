...
3.Give Art a constructor that takes self and three additional parameters: artist, title, medium, and year.
...
26.Update our Client class to have a new method, .sell_artwork(). This method should take two parameters: self, artwork, and price.
...
31.the art is not currently owned and is listed then go through with the transaction! .buy_artwork() should do the following:
